...
namespace Phx.Validation
{
    ...
    public abstract class ValidationResult
    {
        ...
        /// <summary>
        ///     Constructs a succesful <see cref="ValidationResult"/> instance.
        /// </summary>
        ...
        /// <summary>
        ///     Constructs an unsuccesful <see cref="ValidationResult"/> instance.
        /// </summary>
    ...
    /// <summary>
    ///     Represents a successful result of a validation.
    /// </summary>
    ...
    /// <summary>
    ///     Represents a failure result of a validation.
    /// </summary>
    public sealed class FailureResult : ValidationResult
    {
        /// <summary>
        ///     Gets the exception that describes the cause of the failure.
        /// </summary>
