...
namespace Phx.Validation {
    ...
    /// <summary> Contains extension methods used to validate constraints of values. </summary>
    public static class Validations {
        /// <summary> Validates that the given condition is <c> true </c>. </summary>
        ...
        /// <summary> Validates that the given condition is <c> false </c>. </summary>
        /// <param name="condition"> The condition to validate. </param>
        /// <returns> The <see cref="ValidationResult" />. </returns>
        ...
        /// <summary> Validates that the given value is equal to the given expected value. </summary>
        ...
        /// <summary> Validates that the given value is not equal to the given unexpected value. </summary>
        /// <typeparam name="T"> The type of the value to validate. </typeparam>
        /// <param name="value"> The value to validate. </param>
        ...
        /// <summary> Validates that the given value is not <c> null </c>. </summary>
        /// <param name="value"> The value to validate. </param>
        /// <returns> The <see cref="ValidationResult" />. </returns>
        ...
        /// <summary> Validates that the given string value is <c> null </c> or empty. </summary>
        /// <param name="value"> The value to validate. </param>
        /// <returns> The <see cref="ValidationResult" />. </returns>
        ...
        /// <summary> Validates that the given string value is not <c> null </c> or empty. </summary>
        /// <param name="value"> The value to validate. </param>
        /// <returns> The <see cref="ValidationResult" />. </returns>
        ...
        /// <summary> Validates that the given string value is <c> null </c>, empty or entirely whitespace. </summary>
        /// <param name="value"> The value to validate. </param>
        /// <returns> The <see cref="ValidationResult" />. </returns>
        ...
        /// <summary> Validates that the given string value is not <c> null </c>, empty or entirely whitespace. </summary>
        /// <param name="value"> The value to validate. </param>
        /// <returns> The <see cref="ValidationResult" />. </returns>
        ...
        /// <summary> Validates that the given collection is empty. </summary>
        ...
        /// <summary> Validates that the given collection is not empty. </summary>
        /// <param name="collection"> The collection to validate. </param>
        /// <returns> The <see cref="ValidationResult" />. </returns>
        ...
        /// <summary> Validates that the given collection contains the given elements. </summary>
        ...
        /// <summary> Validates that the given collection contains at least one of the given elements. </summary>
        /// <typeparam name="T"> The type of elements contained in the collection. </typeparam>
        /// <param name="collection"> The collection to validate. </param>
        /// <param name="elements"> The elements to search for. </param>
        /// <returns> The <see cref="ValidationResult" />. </returns>
        ...
        /// <summary> Validates that the given value is not 0. </summary>
        /// <param name="value"> The value to validate. </param>
        /// <returns> The <see cref="ValidationResult" />. </returns>
        ...
        /// <summary> Validates that the given value is within the given range. </summary>
        /// <typeparam name="T"> The type of the value to validate. </typeparam>
        /// <param name="value"> The value to validate. </param>
        /// <param name="min">
        ///     The minimum value of the range. <paramref name="min" /> is inclusive by default, use the
        ///     <see cref="minInclusive" /> parameter to change this.
        /// </param>
        /// <param name="max">
        ///     The maximum value of the range. <paramref name="max" /> is inclusive by default, use the
        ///     <see cref="maxInclusive" /> parameter to change this.
        /// </param>
        ...
        /// <summary> Validates that the given value is assignable to the given type or is <c> null </c>. </summary>
        /// <typeparam name="T"> The type to validate against. </typeparam>
        /// <param name="value"> The value to validate. </param>
        /// <returns> The <see cref="ValidationResult" />. </returns>
